        ...
        <div className="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-2" id="menu">
            <nav>
                <ul className="md:flex items-center justify-between text-xs font-bold pt-4 md:pt-0 text-gray-500 uppercase">
                    <li><a className="inline-block no-underline py-2 px-4" href="https://patreon.com/warzonecommunity">Support Us</a></li>
                    <li><a className="inline-block no-underline py-2 px-4" href="/contact">Contact</a></li>
                    <li><a className="inline-block no-underline py-2 px-4" href="/about">About</a></li>
                </ul>
            </nav>
        </div>
